...
![npm](https://img.shields.io/npm/v/ai-api-docs)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-api-docs)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Automated API documentation generation from code comments and types

AI-powered API documentation generator. Extracts JSDoc comments and creates comprehensive documentation.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-api-docs.svg)](https://badge.fury.io/js/ai-api-docs)
